...
address = web3.toChecksumAddress('0x580b90D6908cECD76c41F577Aa481Fe05D47eFD2')
...
address1 = web3.toChecksumAddress('0xAD765F905Ecb7d629eD058283d6Ca1Ed909A8775')
    ...
    if data.each() != None:
        for entry in data.each():
            ...
            for key, value in product.items():
                ...
                qrPath = "C:\Users\jahin\AgriChain\FoodSupp\user\static\Images\QRfiles" + transactionKeys['transactionKey'] + ".svg"
